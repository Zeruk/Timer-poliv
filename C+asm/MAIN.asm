...
SHOWMENU_change_time
	...
	GOTO		$-5
SHOWMENU_change_time1				;;Установка времени
...
SHOWMENU_change_time_MIN
	...
	CALL		BUTTON_SELECT_PROCESSING
	BTFSS		PORTC,B_MODE
	GOTO		SHOWMENU_change_time_MIN
	RLF			IBLINKING		;;МОРГАЕТ ТРЕТИЙ ИНД
	CALL	BUTTON_MODE_PROCESSING

SHOWMENU_change_time_MIN10
	CALL		SHOWING
	BTFSS		PORTC,B_SELECT
	GOTO		$+.11
	...
	CALL		BUTTON_SELECT_PROCESSING
	BTFSS		PORTC,B_MODE
	GOTO		SHOWMENU_change_time_MIN10
	MOVLW		B'00001100'
	MOVWF		IBLINKING		;;МОРГАЕТ ВТОРОЙ И ПЕРВЫЙ ИНД
	CALL	BUTTON_MODE_PROCESSING
SHOWMENU_change_time_HOUR
	CALL		SHOWING
	BTFSS		PORTC,B_SELECT
	GOTO		$+.27
	...
	CALL		BUTTON_SELECT_PROCESSING
	BTFSS		PORTC,B_MODE
	GOTO		SHOWMENU_change_time_HOUR
